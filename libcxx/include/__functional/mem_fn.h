...
public:
  ...
  enable_if_t<__invokable<type, _ArgTypes...>::value, typename __invoke_return<type, _ArgTypes...>::type>
  operator()(_ArgTypes&&... __args) const noexcept(noexcept(std::__invoke(__f_, std::forward<_ArgTypes>(__args)...))) {
